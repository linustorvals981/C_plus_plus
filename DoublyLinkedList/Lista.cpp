...
Pelicula *crearPelicula(string nombre, int precio, struct Duracion duracion,
                        string genero1, string genero2, int dia, int mes,
                        int anio, int horas, int minutos) {
  ...
  if (genero1.compare("animacion") == 0 || genero2.compare("animacion") == 0) {
    nuevo->genero.animacion = true;
  }
...
int pushBack(string nombre, int precio, struct Duracion duracion,
             string genero1, string genero2, int dia, int mes, int anio,
...
int pushFront(string nombre, int precio, struct Duracion duracion,
              string genero1, string genero2, int dia, int mes, int anio,
              int horas, int minutos) {
  Pelicula *nuevo = crearPelicula(nombre, precio, duracion, genero1, genero2,
                                  dia, mes, anio, horas, minutos);
...
int pushFecha(string nombre, int precio, struct Duracion duracion,
              string genero1, string genero2, int dia, int mes, int anio,
              int horas, int minutos) {
  Pelicula *nuevo = crearPelicula(nombre, precio, duracion, genero1, genero2,
                                  dia, mes, anio, horas, minutos);
  ...
  while (actual->siguiente != nullptr &&
         actual->siguiente->fecha_lanzamiento->anio <= anio &&
         actual->siguiente->fecha_lanzamiento->mes <= mes &&
         actual->siguiente->fecha_lanzamiento->dia <= dia) {
    actual = actual->siguiente;
  }
  if (actual == nullptr) {
    pushBack(nombre, precio, duracion, genero1, genero2, dia, mes, anio, horas,
             minutos);
    return 0;
  }
...
int main() {
  pushFecha("Pelicula 1", 10, {1, 1, 2022}, "accion", "terror", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 2", 10, {1, 1, 2022}, "comedia", "drama", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 3", 10, {1, 1, 2022}, "romance", "terror", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 4", 10, {1, 1, 2022}, "accion", "suspenso", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 5", 10, {1, 1, 2022}, "accion", "terror", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 6", 10, {1, 1, 2022}, "musical", "accion", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 7", 10, {1, 1, 2022}, "accion", "terror", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 8", 10, {1, 1, 2022}, "accion", "terror", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 9", 10, {1, 1, 2022}, "accion", "terror", 1, 1, 2022, 1,
            1);
  pushFecha("Pelicula 10", 10, {1, 1, 2022}, "accion", "terror", 1, 1, 2022, 1,
            1);
  printList();
  return 0;
}
